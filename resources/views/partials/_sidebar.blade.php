    ...
    <section class="sidebar">
     ...
     {{--  <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <p> {{ucwords(Auth::user()->body)}} </p>
 --}}
{{-- @if($user->isOnline())
    <a href="#"><i class="fa fa-circle text-success">Online</i></a>
@else
    <a href="#"><i class="fa fa-circle text-danger">Offline</i></a>    
@endif --}}
          {{-- <a href="#">
          <i class="fa fa-circle text-success"></i>@if($user->isOnline()) Online!! 
          @else Offline @endif </a> --}}
        </div>
      </div>
      &nbsp;
      <!-- search form -->
